...
```
Copy and paste this "raw" file content of this [daily_push.yaml](https://github.com/EmmanuelLefevre/GithubDailyStreakAutomation/blob/main/.github/workflows/daily_push.yml) file into yours...  
